...
const PUB_API  = ['/api/auth/login', '/api/auth/register', '/api/auth/refresh', '/api/ai/chat', '/api/diagnostic', '/api/voice', '/api/debug', '/api/workflow-debug', '/api/patients', '/api/db-setup'];
